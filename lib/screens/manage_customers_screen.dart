    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          labelStyle: GoogleFonts.outfit(fontWeight: FontWeight.bold, fontSize: 14, color: Colors.white),
          unselectedLabelStyle: GoogleFonts.outfit(fontWeight: FontWeight.bold, fontSize: 14, color: Colors.white70),
          tabs: const [
            Tab(text: 'Customer Directory'),
            Tab(text: 'Member Discounts & Rules'),
          ],
        ),
      ),
      body: _isLoading
